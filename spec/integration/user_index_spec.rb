...
RSpec.describe 'UsersIndex', type: :system do
  before do
    @user1 = User.create!(name: 'User1', photo: 'https://my.alfred.edu/zoom/_images/foster-lake.jpg',
                          bio: 'Bio for User1', postscounter: 2)
    ...
    @user2 = User.create!(name: 'User2', photo: 'https://my.alfred.edu/zoom/_images/foster-lake.jpg',
                          bio: 'Bio for User2', postscounter: 1)
