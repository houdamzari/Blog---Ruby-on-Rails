...
before do
      @user1 = User.create!(id: 4, name: 'User1', photo: 'https://my.alfred.edu/zoom/_images/foster-lake.jpg', bio: 'Bio for User 4', postscounter: 1)
  @post1 = @user1.posts.create!(
    ...
    @user2 = User.create!(id: 5, name: 'User2', photo: 'https://my.alfred.edu/zoom/_images/foster-lake.jpg', bio: 'Bio for User2', postscounter: 1)
